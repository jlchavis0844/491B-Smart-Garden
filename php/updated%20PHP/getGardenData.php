...
startDate=date value either YYYY-MM-DD hh:mm:ss or just YYYY-MM-DD (min date)
endDate=date value either YYYY-MM-DD hh:mm:ss or just YYYY-MM-DD (max date)
...
WHERE logintable.userName = '$gUser' AND gardentbl.gardenName = '$gName' AND readings.timeStamp >= '$gMin' AND readings.timeStamp <= '$gMax';";
